...
type Config struct {
	...
	MinPoolSize uint64   `env:"MIN_POOL_SIZE" yaml:"minPoolSize" envDefault:"1"`
	MaxPoolSize uint64   `env:"MAX_POOL_SIZE" yaml:"maxPoolSize" envDefault:"10"`

	UserName    string `env:"USERNAME" yaml:"username" envDefault:"root"`
	Password    string `env:"PASSWORD" yaml:"password" envDefault:"root"`
	PasswordSet bool   `env:"PASSWORD_SET" yaml:"passwordSet" envDefault:"false"`
}
